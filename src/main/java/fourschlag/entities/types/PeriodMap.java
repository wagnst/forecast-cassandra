...
/**
 * Generic subclass of LinkedHashMap that uses integer values as keys and
...
public class PeriodMap<V> extends LinkedHashMap<Integer, V> {
    /**
     * Constructor for PeriodMap. Fills the map with integer values as keys of a
     * certain time span. The value is set to null.
     *
