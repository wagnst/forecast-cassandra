...
public interface ActualSalesAccessor {
     ...
     *
     * @return One database row mapped as ActualSalesEntity. Is null if no data
     * was found.
     */
     ...
     *
     * @return Iterable of entities mapped as ActualSalesEntity with all
     * combinations
     */
     ...
     * @param salesType        primary key field sales_type for where clause
     * @param dataSource       primary key field data_source for where clause
     * @param periodFrom       primary key field period to start with for where
     *                         clause
     * @param periodTo         primary key field period to end with for where
     *                         clause
     *
     * @return Iterable of entities mapped as ActualFixedCostsEntity. Is empty
